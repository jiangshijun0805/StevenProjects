...
public class OperateGBCExcel {
    ...
    public static void readXml(String fileName)
        ...
        try {
            ...
            Sheet sheet = wb.getSheetAt(1); //获得第2个表单  
                        ...
                        if (temp_col03 != "" && temp_col04 == "") {
                            ...
                            if (temp_col04 != "") {
                                ...
                                if (add_col != "") {
                                    ...
                                    model = new Gbc();
                                    model.setGbc(col01 + col04.substring(0, col04.length() - 1));
                                    model.setDescription_cn(temp_col05);
                                    model.setParent_cn(set);
                                    model.setUpdate_ts(System.currentTimeMillis());
                                    String jsonStr = JSON.toJSONString(model);
